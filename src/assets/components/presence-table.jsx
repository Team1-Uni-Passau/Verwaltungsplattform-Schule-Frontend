...
export default class PresenceTable extends React.Component {
    ...
    async getPresenceForStudent() {
        await fetch(isLocalhost ? PATHS.REACT_APP_PATH_LOCAL + '/eltern/praesenz/'+JSON.parse(localStorage.getItem("loggedIn")).userId : PATHS.REACT_APP_PATH_PROD + '/eltern/praesenz/'+JSON.parse(localStorage.getItem("loggedIn")).userId, {
            method: 'GET',
            headers: {
