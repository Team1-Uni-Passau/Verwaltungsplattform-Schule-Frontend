...
export default class PresenceTable extends React.Component {
    ...
    async getGradeschemaForStudent() {
        await fetch(isLocalhost ? PATHS.REACT_APP_PATH_LOCAL + '/eltern/noten/notenschema/'+JSON.parse(localStorage.getItem("loggedIn")).userId : PATHS.REACT_APP_PATH_PROD + '/eltern/noten/notenschema/'+JSON.parse(localStorage.getItem("loggedIn")).userId, {
            method: 'GET',
            headers: {
