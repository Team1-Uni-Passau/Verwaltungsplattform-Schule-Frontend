...
export default class Homepage extends React.Component {
    ...
    async handleLogin() {
        ...
        if (this.username && this.password) {
            await fetch(isLocalhost ? PATHS.REACT_APP_PATH_LOCAL + '/login' : PATHS.REACT_APP_PATH_PROD + '/login', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
            ...
            <div className="wrapper">
                ...
                <Modal show={this.state.displayModal} modalClosed={() => this.undisplayModal()}>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-content" style={this.state.DisplayId ? void (0) : { display: 'none' }}>
                        ...
                        <p className="form-validation-registration" style={!this.state.CheckboxSelected && this.state.RegistrationConfirmed ? void(0) : { display: 'none' } }>Wählen sie ihre Rolle</p>
